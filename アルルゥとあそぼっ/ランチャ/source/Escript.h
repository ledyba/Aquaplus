...
#define SCCODE_OPRS_NOOPR			0					
#define SCCODE_OPRS_RUN				1					
#define SCCODE_OPRS_WAIT_WAIT		2					
#define SCCODE_OPRS_WAIT_TWAIT		3					
#define SCCODE_OPRS_WAIT_SLOAD		4					
#define SCCODE_OPRS_WAIT_DEBUG		0xFF				
...
extern BOOL		EXEC_StartLang( EXEC_DATA *scr, int EXEC_no );
